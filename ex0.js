...
const ws = new Wampy('ws://localhost:86/ws',
  {
    realm: 'realm1',
...
const ws0 = new Wampy('ws://localhost:86/ws',
  {
    realm: 'realm1',
    onError: function(...args) {
      console.log('on error', ...args);
...
ws0.subscribe('client.message', function (dataArr, dataObj) { console.log('Received client.message event!'); })
...
setTimeout(() => ws0.publish('client.message', 'Hi guys!'), 5000);
